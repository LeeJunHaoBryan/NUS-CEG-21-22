...
def Tut7_Q2():
    ...
    plt.savefig('Figures/fig_tut7_Q1a_curves.png')
    ...
    plt.savefig('Figures/fig_tut7_Q1a_MSE.png')
    ...
    plt.ylim(-4, 6)
    plt.legend(loc='lower left',ncol=3, fontsize=15)
    plt.savefig('Figures/fig_tut7_Q1b_curves.png')
    ...
    plt.title('With Regularization')
    plt.legend(loc='upper left', fontsize=15)
    plt.savefig('Figures/fig_tut7_Q1b_MSE.png')
